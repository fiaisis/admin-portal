...
# COPY --from=deps --chown=nextjs:nodejs /application/.next/standalone ./
COPY --from=deps --chown=nextjs:nodejs /application/.next/static ./.next/static
